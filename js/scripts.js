    ...
    $("#checkout").click(function () {
      ...
      if (checkout === false) {
        ...
        if (locate === "") {
          ...
          var deliverPrice = 250;
          $("#listOrders").append("<p class=\"grandTotal text-center\">" + "Delivery Fee : " + "<span class=\"totalPizza text-dark\">" + deliverPrice + "</span>" + "</p>");
          var sum = 0;
          $('.totalPizza').each(function () {
            sum += parseFloat($(this).text());
          });
          alert("Delivery Fee : "+deliverPrice);
